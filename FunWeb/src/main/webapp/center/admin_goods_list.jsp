		...
		<article>
			...
			<table id="notice">
				...
				<tr>
					...
					<td>${dto.category }</td>
					<td>
						<img src="./upload/${dto.image.split(',')[0]}"  width="50" height="50"> <!--썸네일 만들어보기!  -->
					</td>
					<td>${dto.price }</td>
					<td>${dto.amount }</td>
					...
					<td>
						...
						/
						<a href="./adminGoodsDelete.ag?gno=${dto.gno }">삭제</a>
					</td>
				</tr>
				</c:forEach>
			</table>
			<div id="table_search">
				<input type="button" value="상품등록" class="btn" onclick="location.href='./AdminGoodsAdd.ag';"> 
