...
<h1> 주문 목록(관리자) </h1>
	...
	<table id="notice">
		...
		<tr>
			<th class="tno">상품명</th>
			<th class="twrite">상품사이즈</th>
			<th class="tdate">상품컬러</th>
		...
		<tr>
		   <td colspan="8">
		   	받는사람 : ${adminOrderDetail[0].o_r_name }<br> <%-- ${adminOrderDetail[0].o_r_name } --%>
		   	연락처 : ${adminOrderDetail[0].o_r_phone }<br>
		   	주소 : ${aodDTO.o_r_addr1 }<br>
		   	메세지 : ${aodDTO.o_r_msg }<br>
		   </td>
		</tr>
		<tr>
		   <th class="ttitle" colspan="8">
		...
		<tr>
		   <td colspan="8">
		   	결제방법 : ${aodDTO.o_trade_type}<br> <%-- ${adminOrderDetail[0].o_r_name } --%>
