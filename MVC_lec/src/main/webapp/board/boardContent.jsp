...
<body>
	...
	<table border="1">
		...
		<tr>
			<td>첨부파일</td>
			<td colspan="3"><a href="" >${dto.file }</a></td>
		</tr>
		<tr>
			<td colspan="4">
				...
				<input type="button" value="답글" onclick="location.href='./BoardReWrite.bo?bno=${dto.bno}&pageNum=${pageNum}&re_ref=${dto.re_ref}&re_seq=${dto.re_seq}&re_lev=${dto.re_lev}';">
